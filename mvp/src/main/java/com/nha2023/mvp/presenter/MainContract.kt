...
//View와 Presenter역할을 하는 클래스들이 가지고 있어야 할 기능을 정하는 인터페이스
...
interface MainContract {
    ...
    interface View{
        ...
        fun getContext():Context //2) presenter에서 사용할 수있는 Context를 리턴해주는 기능(추상메소드)
    ...
    interface Presenter{
        ...
        fun clickSave(name:String, email:String) //1) save버튼을 클릭 했을 때
        fun clickLoad() //2) load버튼을 눌렀을 때
    }
